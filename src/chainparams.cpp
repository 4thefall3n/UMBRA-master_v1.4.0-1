...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (     0, uint256("0x0000026e13bea81af4fe7e79c41536e912827854deba9723d1b342b80e572627"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1540961470, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "JPMorgan (JPM) Q1 Earnings Beat on Better Rates and Trading  - May 23 2018 - Remapper";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1540961470;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2459082;

	hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000026e13bea81af4fe7e79c41536e912827854deba9723d1b342b80e572627"));
        assert(genesis.hashMerkleRoot == uint256("0xc5ad6d6b723ab7616b3ff362c7b88191c3e87e754c98c0a5cd5d65f8fffae478"));
        ...
        strObfuscationPoolDummyAddress = "UNjxeg9g1c36ZhyZ5cP8z6ucNbfpuuwbvb";
        nStartMasternodePayments = 1540961470;
